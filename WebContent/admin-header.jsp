			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active"><a class="nav-link"
						href="adminHome.jsp"><i class="fa fa-home" aria-hidden="true"></i><span
							class="header-menu">Home </span> </a></li>
					...
					<li class="nav-item dropdown"><a
						...
						aria-expanded="false"> <i class="fa fa-cogs"
							aria-hidden="true"></i><span class="header-menu">Manage </span></a>
						<div class="dropdown-menu dropdown-font"
							aria-labelledby="navbarDropdown">
							<form action="AdminController" method="post">
								<input type="hidden" name="action" value="addDeleteStudent">
								<input class="dropdown-item dropdown-font pointer" type="submit"
									value="Student" />
							</form>
							<form action="AdminController" method="post">
								<input type="hidden" name="action" value="getTerms"> <input
									class="dropdown-item dropdown-font pointer" type="submit"
									value="Course" />
							</form>
							<form action="AdminController" method="post">
